...
dtfactor = 1;
pde.dt = 1e-4*ones(1,10000/dtfactor)*5*dtfactor;   % time step sizes
pde.visdt = pde.dt(1);         % visualization timestep size
pde.saveSolFreq = ceil(10000/(dtfactor*10));          % solution is saved every 10 time steps
...
[mesh.p,mesh.t,mesh.dgnodes] = mkmesh_circincirc_Ma17b(pde.porder,51,51,1,3,2);
