...
pde.saveSolFreq = nt/10;          % solution is saved every 10 time steps
...
% pde.matvectol=1e-3;             % tolerance for matrix-vector multiplication
pde.AV = 1;                     % artificial viscosity
pde.timestepOffset=0;

[mesh.p,mesh.t,mesh.dgnodes] = mkmesh_circincirc_Ma17b(pde.porder,21,41,1,3,10);
