...
%PDEMODEL Equilibrium five-species-air compressible Navier--Stokes model.
%
% The model supports Cartesian 1-D, 2-D, and 3-D states.  The conservative
% variables are
%
...
function s = visscalars(u, q, w, v, x, t, mu, eta)
    % Use the same physical sensor as the ideal-gas Mach-8 reference:
    % nondimensional pressure. The equilibrium pressure is supplied by the
    % material database in w(1), while mu(3) is the pressure scale.
    s = w(1)/mu(3);
end
