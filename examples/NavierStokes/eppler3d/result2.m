...
[Cp,Cf,x,Cp2d,Cf2d,x2d,Ch,Ch2d] = getsurfacedata(master2d,mesh2d,UDGspm,param,wid,1,1,xyMidChord);

data = load('Eppler387_Re300000_alpha4_experimental_Cp.mat');
...
figure(1);clf;plot(x(:,1),Cp);axis tight
hold on;
plot(upper(:,1), -upper(:,2), 'o-', ...
     lower(:,1), -lower(:,2), 's-');
