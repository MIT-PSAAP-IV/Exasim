...
elseif gridNum==-3      % p=4, Coarse mesh
   n1=36*porder+1; n2=24*porder+1; n3=32*porder+1; 
   TEC = 15;
   [x,y] = cmeshparam6(n1, n2, n2, n2+8*porder, n2+16*porder, n3, ...
                        [TEC, 1, 1, 1, 1, TEC, 1, 1, 1, 1, TEC], ...
                        [10, 10, 10, 10, 10, 10, 10]*25);   
elseif gridNum==-2  % p=4, Fine mesh
   n1=38*porder+1; n2=24*porder+1; n3=32*porder+1; 
   TEC = 15;
   [x,y] = cmeshparam6(n1, n2, n2-3*porder, n2+4*porder, n2+8*porder, n3, ...
                        [TEC, 1, 1, 1, 1, TEC, 1, 1, 1, 1, TEC], ...
