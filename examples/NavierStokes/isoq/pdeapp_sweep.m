% Physics-parameter sweep for the isoq Navier-Stokes example.
%
...
%
% With pde.physicsparamwarmstart = 1, each case after the first uses the
% converged solution from the previous case as its initial condition.
...
% Sweep the artificial-viscosity parameter around the pdeapp3 baseline.
% Users can edit this vector or replace pde.physicsparamsweep with any
% ncases-by-numel(basePhysicsParam) array.
...
figure(1); clf; scaplot(mesh, eulereval(solplot, 'M',gam,Minf),[0 Minf],1); colorbar;
