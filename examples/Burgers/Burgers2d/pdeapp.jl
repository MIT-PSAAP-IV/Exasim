...
pde.physicsparam = [0.01 0 1 0.5 0];    # thermal conductivity and boundary value
...
mesh.boundarycondition = [1 1 2 1]; # Set boundary condition for each disjoint boundary
