...
box on;
grid on;
leg = legend({'$T = 1000 \mbox{ } \mathrm{K}, t = 0.160 \mbox{ } \mathrm{s}$','$T = 1500 \mbox{ } \mathrm{K}, t = 0.111 \mbox{ } \mathrm{s}$','$T = 2000 \mbox{ } \mathrm{K}, t = 0.096 \mbox{ } \mathrm{s}$','$t = 0.096 \mbox{ } \mathrm{s}$'}, 'interpreter', 'latex', 'FontSize', 20, 'Location', 'NE');
leg.ItemTokenSize = [40,10];
