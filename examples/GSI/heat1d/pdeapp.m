...
heatflux = 1.75;            % dimensionless heat flux
lambda = sqrt(200);
mu = [L Twall T0 R kB k H0 mu0 C0 D0 H tc Dc DTHf CvHf heatflux lambda];
...
nsteps = 100;
tfstar = 1; % dimensionless final time 
dt = tfstar/nsteps;  % timestep size
