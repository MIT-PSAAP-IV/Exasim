...
lambda=lambda+(2/3)*mu;

% Set discretization parameters, physical parameters, and solver parameters
pde.porder = 3;             % polynomial degree
pde.pgauss = 2*pde.porder;  % gauss quad order
pde.physicsparam = [mu lambda 1.25 0]; 
pde.tau = 60;              % DG stabilization parameter
...
mesh.boundarycondition = [1;3;1;2]; % Set boundary condition for each boundary
