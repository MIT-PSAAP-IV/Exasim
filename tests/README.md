...
| `frontend_python_exporttext2code` | Python frontend exports a Text2Code package (`pdemodel.txt`, `pdeapp.txt`, `grid.bin`, optional field binaries), then the installed `text2code` regenerates `datain/` from that package. |
