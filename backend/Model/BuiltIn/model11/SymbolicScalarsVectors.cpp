...
SymbolicScalarsVectors::SymbolicScalarsVectors() {
    ...
    funcnames = {"Flux", "Source", "Tdfunc", "Fbou", "Ubou", "FbouHdg", "Initu", "VisScalars", "VisVectors", "HeatFlux", "ViscousStress", "Fint", "Fext"};
    ...
    funcdecls = {
       ...
       "void ViscousStress(dstype* f, const dstype* x, const dstype* uhat, const dstype* uq, const dstype* v, const dstype* w, const dstype* eta, const dstype* mu, const dstype t, const int modelnumber, const int N, const int szx, const int szuhat, const int szuq, const int szv, const int szw, const int szeta, const int szmu)", 
...
std::vector<Expression> SymbolicScalarsVectors::evaluateSymbolicFunctions(int call)
{
  ...
  switch (call) {
    ...
    case 9:
      ...
      break;
    case 10:
      f = ViscousStress(x, uhat, uq, v, w, eta, mu, t);
      break;
    case 11:
...
void SymbolicScalarsVectors::generateModelHeader(const std::string& filename) {
    ...
    hfile << "    static constexpr int nco    = 1;\n";
    hfile << "    static constexpr int nparam = 12;\n";
