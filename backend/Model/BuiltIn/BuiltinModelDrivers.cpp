...
{     
  ...
  builtinKokkosInitodg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nco, npe, ne);                
}
...
{     
  ...
  builtinKokkosInitq(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                    
}
...
{     
  ...
  builtinKokkosInitudg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
}
...
{     
  ...
  builtinKokkosInitu(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
}
...
{     
  ...
  builtinKokkosInitwdg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, ncw, npe, ne);                
}
...
{     
  ...
  builtincpuInitodg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nco, npe, ne);                
}
...
{     
  ...
  builtincpuInitq(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
...
{     
  ...
  builtincpuInitudg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
}
...
{     
  ...
  builtincpuInitu(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, nc, npe, ne);                
}
...
{     
  ...
  builtincpuInitwdg(f, xg, app.uinf, app.physicsparam, app.builtinmodelID, numPoints, ncx, ncw, npe, ne);                
}
        ...
        masterstruct &master, appstruct &app, solstruct &sol, tempstruct &temp, commonstruct &common, Int nga, Int ib, Int backend)
{
    builtinHdgFext(f, f_udg, f_wdg, f_uhg, xg, udg, odg, wdg, uhg, nl, uext, app.tau, app.uinf, app.physicsparam, common.timestate.time, 
              common.builtinmodelID, ib, nga, common.components.nc, common.components.ncu, common.nd, common.components.ncx, common.components.nco, common.components.ncw);
}
