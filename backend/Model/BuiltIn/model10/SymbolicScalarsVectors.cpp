...
SymbolicScalarsVectors::SymbolicScalarsVectors() {
    ...
    outputfunctions.assign(11, false);
    ...
    funcnames = {"Flux", "Source", "Tdfunc", "Fbou", "Ubou", "FbouHdg", "Fext", "Initu", "VisScalars", "VisVectors", "Fint"};
