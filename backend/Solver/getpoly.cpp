...
template <class M>
void makeH(CAssembler<M>& assembler, CDiscretization &disc, CPreconditioner<M>& prec, sysstruct &sys, 
...
template <class M>
void getPoly(CAssembler<M>& assembler, CDiscretization &disc, CPreconditioner<M>& prec, sysstruct &sys, 
