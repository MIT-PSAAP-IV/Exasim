...
function(exasim_add_external_builtin_model)
  ...
  # sizes are read from a per-model translation unit (_model_sizes_<ID>.cpp)
  # that includes my_model.hpp in its own TU, avoiding #pragma once collisions
  # when multiple models share one provider.
  set(_includes "")
  ...
  foreach(_id IN LISTS EXT_IDS)
    ...
    if(EXT_PDEMODEL)
      ...
      # my_model.hpp (generated by text2code) and exposes the constexpr
      # PdeModel sizes via a C-linkage function.  Separate TU avoids
      # #pragma once collisions when multiple models share one provider.
      set(_size_src "${_gendir}/model${_id}/_model_sizes.cpp")
      set(_size_content
...
")
      ...
      list(APPEND _ext_size_sources "${_size_src}")
    endif()
  endforeach()
  set(EXT_MODEL_IDS_MACRO "${_idmacro}")
  if(EXT_PDEMODEL)
    set(EXT_MODEL_HAS_MY_MODEL "1")
  else()
