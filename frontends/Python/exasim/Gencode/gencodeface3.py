...
def gencodeface3(filename, f, xdg, udg1, udg2, odg1, odg2, wdg1, wdg2, uhg, nlg, tau, uinf, param, time, foldername):
    ...
    for i in range(1, len(f.flatten()) + 1):
        a = "f[" + str(i - 1) + "*ng+i] ="
        b = "f[" + str(i - 1) + "*ng+i] +="
        str_code = str_code.replace(a, b)
...
# def gencodeface3(filename, f, xdg, udg1, udg2, odg1, odg2, wdg1, wdg2, uhg, nlg, tau, uinf, param, time):
...
#     mystr = varsassign(mystr, "udg1", len(udg1), 1);
#     mystr = varsassign(mystr, "udg2", len(udg2), 1);
#     mystr = varsassign(mystr, "uhg", len(uhg), 1);
#     mystr = varsassign(mystr, "odg1", len(odg1), 1);
#     mystr = varsassign(mystr, "odg2", len(odg2), 1);
#     mystr = varsassign(mystr, "wdg1", len(wdg1), 1);
#     mystr = varsassign(mystr, "wdg2", len(wdg2), 1);
#     mystr = varsassign(mystr, "nlg", len(nlg), 1);
#     mystr = sympyassign(mystr, f);
#     mystr = mystr.replace("dgp","dg1")
#     mystr = mystr.replace("dgm","dg2")
