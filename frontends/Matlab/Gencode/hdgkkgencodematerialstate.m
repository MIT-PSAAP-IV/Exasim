function strkk = hdgkkgencodematerialstate(filename, f, xdg, udg, odg, wdg, uinf, param, time, foldername)
...
str = string("\tKokkos::parallel_for(") + char(34) + filename + char(34) + ", ng, KOKKOS_LAMBDA(const size_t i) {\n";
strkk = "void " + cpufile;
strkk = strkk + tmp + "{\n";
strkk = strkk + str;
