function strkk = hdgkknocodematerialstate(filename, foldername)
...
strkk = "void " + cpufile;
strkk = strkk + tmp + "{\n";
strkk = strkk + "    (void)f; (void)f_udg; (void)f_wdg; (void)xdg; (void)udg; (void)odg; (void)wdg; (void)uinf;\n";
strkk = strkk + "    (void)param; (void)time; (void)modelnumber; (void)ng; (void)nc;\n";
strkk = strkk + "    (void)ncu; (void)nd; (void)ncx; (void)nco; (void)ncw; (void)nmaterialstate;\n";
strkk = strkk + "}\n";
