...
pde.elemtype = 1;
pde.nodetype = 1;
pde.uniformrefinementlevel = 0; % refine the input mesh uniformly this many times
pde.hybrid = 0;
pde.tdep = 0;
pde.wave = 0;
pde.linearproblem = 0;
...
pde.distanceboundaryconditions = [];
...
pde.meshadaptfield = 1; % one-based VisScalars component used by the discontinuity sensor
pde.meshadaptavcomponent = 1; % one-based AV component
