...
requiredKeys = ["exasimpath", "datapath", "model", "modelfile", "meshfile", "xdgfile",...
  "udgfile", "vdgfile", "wdgfile", "uniformrefinementlevel", "materialdatabase", "discretization",...
  ...
  "preconditioner", "saveSolFreq", "saveSolOpt", "saveSolBouFreq", "ibs", "saveSolBouLoc", "saveParaview",...
  "physicsparamwarmstart", "AV", "AVdistfunction", "distanceboundaryconditions", "AVsmoothingIter", ...
  "AVsmoothingMethod", "AVHelmholtzCoeff", "AVcontinuationIter", ...
  "AVcontinuationLogScale", "AVcoeffStart", "AVcoeffEnd", "frozenAVflag", ...
  "meshadaptenabled", "meshadaptfield", "meshadaptavcomponent", ...
  "meshadaptsmoothingpasses", "meshadaptiterations", "meshadaptalpha", ...
  "meshadaptqmin", "meshadaptqmax", "meshadaptHelmholtzCoeff", ...
  "meshadapttargetexponent", "meshadaptpoissonratio", "meshadaptyoungmodulus", ...
  "meshadaptminimumyoungmodulus", "meshadaptshearscale", ...
  "meshadaptvolumetricscale", "meshadaptforcescale", "meshadaptdamping", ...
  "meshadaptminimumjacobianratio", "meshadaptHelmholtzTau", ...
  "meshadaptelasticitytau", "meshadaptboundaryconditions", ...
...
for i = 1:length(requiredKeys)
    ...
    if match == 1
       value = pde.(key);
      if key == "materialdatabase" && isempty(strtrim(char(value)))
        continue;
      end
      if isnumeric(value) || islogical(value)        
        ...
        elseif length(value)==1
          if key == "dt" || key == "tau" || key == "physicsparam" || key == "externalparam" || key == "boundaryconditions" || key == "distanceboundaryconditions" || key == "meshadaptboundaryconditions" || key == "stgib" || key == "stgdata" || key == "stgparam" || key == "wmModelIDs" || key == "wmBoundaries" || key == "wmDistances" || key == "curvedboundaries" || key == "periodicboundaries1" || key == "periodicboundaries2" || key == "interfacefluxmap"
